$(document).ready(function () {
    ...
    function switchTheme(themeName) {
    	...
    	var basePath=pathName.substring("0",pathName.indexOf("/",2));
        if (themeName == 'classic') {
            $('#bs-css').attr('href', basePath+'/resources/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', basePath+'/resources/css/bootstrap-' + themeName + '.min.css');
        }
